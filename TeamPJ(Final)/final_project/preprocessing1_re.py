...
# 관광지 선택
visit_area_info = visit_area_info[ (visit_area_info['VISIT_AREA_TYPE_CD'] == 11)]
...
#train set 저장
new_train.to_csv(path + '/source/관광지 추천시스템 Trainset_final_re.csv', index = False)
#test set 저장
df1.to_csv(path + '/source/관광지 추천시스템 Testset_final_re.csv', index = False)
